...
const Delete=async(id)=>{
  ...
  return (
    <SafeAreaView style={{flex: 1,backgroundColor: '#2DB8F0' }}>
      <View style={{flex: 1, backgroundColor: '#2DB8F0',justifyContent: 'center',alignItems:'center'}}>
        <View >
          <ScrollView keyboardShouldPersistTaps="handled">
            <KeyboardAvoidingView
              behavior="padding"
              style={{flex: 1, justifyContent: 'space-between',backgroundColor: 'aqua',borderRadius:12,marginTop:80}}>
